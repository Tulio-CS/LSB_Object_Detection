...
model = tf.keras.models.load_model('models/one_hand/One_Hand.h5')
model.load_weights("models/one_hand/One_Hand.weights.h5")

labels = {0:"A",1:"B",2:"C",3:"D",4:"E",5:"I",6:"L",7:"M",8:"N",9:"O",10:"U",11:"V",12:"W"}
threshold=0.9

encoder = joblib.load("encoders/one_hand/One_Hand_encoder.pkl")
scaler = joblib.load("encoders/one_hand/One_Hand_scaler.pkl")
